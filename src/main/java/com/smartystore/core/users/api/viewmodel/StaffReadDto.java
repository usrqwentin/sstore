...
import com.smartystore.core.users.api.StaffPage;
...
public class StaffReadDto extends ApiData {
  ...
  public static StaffReadDto fromEntity(Staff user) {
    StaffReadDto vm = new StaffReadDto();
    vm.setId(user.getId());
